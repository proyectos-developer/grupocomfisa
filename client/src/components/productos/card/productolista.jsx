...
export default function CardProductoLista({producto, proporcional}) {
    ...
    return (
        <div className='shadow rounded' style={{width: 280 / proporcional, marginRight: 10 / proporcional, marginLeft: 10 / proporcional, marginBottom: 40 / proporcional}}
            onMouseOver={() => setViewOpcions(true)} onMouseLeave={() => setViewOpcions(false)}>
            <img src={producto.foto_uno} style={{width: 280 / proporcional, height: 280 / proporcional}}/>
            <div className='position-relative' style={{width: 280 / proporcional}}>
                <div className='d-flex' style={{width: 280 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
                ...
                <div className={`position-absolute start-0 ${view_opciones ? 'animate__animated animate__bounceIn' : 'top-0 animate__animated animate__bounceOut'}`} 
                    style={{width: 260 / proporcional, top: '30%', marginLeft: 10 / proporcional, marginRight: 10 / proporcional,}}>
                    <button className='btn' style={{width: 260 / proporcional, background: '#d18e32', height: 50 / proporcional, marginTop: 5 / proporcional,
                        marginBottom: 10 / proporcional, color: 'white', fontWeight: 400, fontSize: 16 / proporcional}}
                        onClick={() => ver_detalles_producto(producto)}>
                        Ver más detalles
                    </button>
                    <div style={{width: 260 / proporcional}} className='d-flex justify-content-between'>
                        <div className='d-flex justify-content-center' style={{width: 130 / proporcional}}>
                            <img src={opcion_icono === 'favoritos' ? icono_favoritos_black : icono_favoritos} 
                                style={{width: 32 / proporcional, height: 32 / proporcional, cursor: 'pointer'}}
                                onMouseOver={() => setOpcionIcono('favoritos')} onMouseLeave={() => setOpcionIcono('')}
                                onClick={() => agregar_favoritos()}/>
                        </div>
                        <div className='d-flex justify-content-center' style={{width: 130 / proporcional}}>
                            <img src={opcion_icono === 'carrito' ? icono_carr_black : icono_carr_add} 
                            style={{width: 32 / proporcional, height: 32 / proporcional, cursor: 'pointer'}}
