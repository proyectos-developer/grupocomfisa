...
export default function CardProductoListaTablet({producto, proporcional}) {
    ...
    return (
        <div className='shadow rounded' style={{width: 415.5 / proporcional, marginBottom: 40 / proporcional, marginLeft: 10 / proporcional, marginRight: 10 / proporcional}}
            onMouseOver={() => setViewOpcions(true)} onMouseLeave={() => setViewOpcions(false)}>
            <img src={producto.foto_uno} style={{width: 415.5 / proporcional, height: 415.5 / proporcional}}/>
            <div className='position-relative' style={{width: 415.5 / proporcional}}>
                <div className='d-flex' style={{width: 251 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
                ...
                <div className='d-flex' style={{width: 415.5 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
                ...
                <div className={`position-absolute start-0 ${view_opciones ? 'animate__animated animate__bounceIn' : 'top-0 animate__animated animate__bounceOut'}`} 
                    style={{width: 395.5 / proporcional, top: '30%', marginLeft: 10 / proporcional, marginRight: 10 / proporcional,}}>
                    <button className='btn' style={{width: 395.5 / proporcional, background: '#d18e32', height: 50 / proporcional, marginTop: 5 / proporcional,
                        marginBottom: 10 / proporcional, color: 'white', fontWeight: 400, fontSize: 16 / proporcional}}
                        onClick={() => ver_detalles_producto(producto)}>
                        Ver más detalles
                    </button>
                    <div style={{width: 395.5 / proporcional}} className='d-flex'>
                        <div className='d-flex justify-content-center' style={{width: 197.75 / proporcional}}>
