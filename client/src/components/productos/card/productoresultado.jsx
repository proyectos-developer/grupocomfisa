...
export default function CardProductoResultado({producto, proporcional}) {
    ...
    return (
        <div className='shadow rounded' style={{width: '24%', marginRight: 5 / proporcional, marginLeft: 5 / proporcional, marginBottom: 40 / proporcional}}
