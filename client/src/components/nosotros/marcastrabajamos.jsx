                ...
                <div className="carousel-inner">
                    <div className="carousel-item active" data-bs-interval="2000">
                        <div className='d-flex' style={{width: 1220 / proporcional}}>
                            ...
                            <img className='rounded' src={logo_inkaferro} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 5 / proporcional,
                                marginRight: 5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_metalyck} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 5 / proporcional,
                                marginRight: 5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_treamperu} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 5 / proporcional,
                                marginRight: 5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_piramide} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 5 / proporcional,
                                marginRight: 5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_sagitario} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 5 / proporcional,
                                marginRight: 5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                        </div>
                    </div>
                    <div className="carousel-item" data-bs-interval="2000">
                        <div className='d-flex' style={{width: 1220 / proporcional}}>
                            ...
                            <img className='rounded' src={logo_unacem} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 27 / proporcional,
                                marginRight: 27 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_etsaperu} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 27 / proporcional,
                                marginRight: 27 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_majestad} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 27 / proporcional,
                                marginRight: 27 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_norton} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 27 / proporcional,
                                marginRight: 27 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                        </div>
                    </div>
                    <div className="carousel-item" data-bs-interval="2000">
                        <div className='d-flex' style={{width: 1220 / proporcional}}>
                            <img className='rounded' src={logo_briker} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 27 / proporcional,
                                marginRight: 27 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_comfisa} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 27 / proporcional,
                                marginRight: 27 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_asa} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 27 / proporcional,
                                marginRight: 27 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
