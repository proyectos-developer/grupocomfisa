...
import paul_poblet from '../../assets/locales/paul_poblet_459.png'
import proyectos_flavi from '../../assets/locales/proyectos_flavi_459.png'
import comercializadora_hanna from '../../assets/locales/comercializadora_hanna_459.png'
import house_valery from '../../assets/locales/house_valery_459.png'
import aceros_arequipa from '../../assets/locales/aceros_arequipa_459.png'
    ...
    return (
        <div style={{width: '100%', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, paddingTop: 55 / proporcional, paddingBottom: 55 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 25 / proporcional}}>
                <div style={{width: '99%', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 25 / proporcional}}>
                <div style={{width: '99%', marginLeft: 10 / proporcional, marginRight: 10 / proporcional, 
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '99%', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                    <img src={aceros_arequipa} style={{width: '100%', height: 303 / proporcional, 
                            marginBottom: 21 / proporcional}}/>
                    <p style={{fontSize: 28 / proporcional, color: '#007BA7', fontWeight: 500, lineHeight: `${40 / proporcional}px`, marginBottom: 0, textAlign: 'left'}}>
                        Comercializadora de <br/> Fierro S.A.C
                    </p>
                    <div className='d-flex justify-content-start' style={{width: '100%', height: 'auto'}}>
                        <div className='rounded-pill' style={{width:  '50%', height: 4 / proporcional, background: '#8B4513', marginBottom: 8 / proporcional}}/>
                    </div>
