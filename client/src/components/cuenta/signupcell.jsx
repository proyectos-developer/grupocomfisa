...
export default function SignupCell({proporcional}) {
        ...
        <div style={{background: 'white', width: '100%', paddingTop: 57 / proporcional, marginBottom: 34 / proporcional}}>
            ...
            <div style={{width: 459 / proporcional}}>
                ...
                <input 
                    type='password'
                    className='form-control'
                    style={{width: 459 / proporcional, height: 50 / proporcional, border: `1px solid ${everificar_password ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional, 
                            marginBottom: 25 / proporcional, background: 'white', fontSize: 16 / proporcional}}
