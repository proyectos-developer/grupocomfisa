...
export default function MenuCuentaCell({proporcional}) {
    ...
    return (
        <div style={{width: 459 / proporcional, height: 'auto', marginLeft: 20 / proporcional, marginRight: 20 / proporcional, marginTop: 60 / proporcional,
            ...
            <div className='rounded' style={{width: 459 / proporcional, height: 'auto', border: '1px solid #007BA7'}}>
                <div style={{width: 457 / proporcional, height: 50 / proporcional, borderBottom: '1px solid #007BA7', 
