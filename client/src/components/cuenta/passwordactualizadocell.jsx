...
import TituloPaginaCell from './actualizado/tituloprincipalcell.jsx'
import ActualizacionCorrectaCell from './actualizacionaorrectacell.jsx'
...
export default function PasswordActualizadoCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <ActualizacionCorrectaCell proporcional={proporcional}/>
