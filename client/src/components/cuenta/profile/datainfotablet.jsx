...
export default function DataInfoTablet({proporcional}) {
  ...
  return (
    <div style={{width: 571 / proporcional, background: 'white'}}>
        ...
        <div style={{background: 'white', width: 571 / proporcional, marginBottom: 20 / proporcional}}>
            <div style={{width: 571 / proporcional}}>
                <div className='d-flex' style={{width: 571 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <input 
                        disabled={!editar_info}
                        type='default'
                        className='form-control'
                        style={{width: 275.5 / proporcional, height: 50 / proporcional, border: `1px solid ${enombres ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                    ...
                    <input 
                        ...
                        disabled={!editar_info}
                        className='form-control'
                        style={{width: 275.5 / proporcional, height: 50 / proporcional, border: `1px solid ${eapellidos ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                ...
                <div className='d-flex' style={{width: 571 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <input 
                        ...
                        type='number'
                        className='form-control'
                        style={{width: 275.5 / proporcional, height: 50 / proporcional, border: `1px solid ${enro_telefono ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                            background: 'white', fontSize: 16 / proporcional, marginRight: 10 / proporcional}}
                    ...
                    <input 
                        ...
                        disabled={true}
                        className='form-control'
                        style={{width: 275.5 / proporcional, height: 50 / proporcional, border: `1px solid ${eemail ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                ...
                <div className='d-flex' style={{width: 571 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <select
                        disabled={!editar_info}
                        style={{width: 275.5 / proporcional, marginRight: 10 / proporcional, border: '1px solid rgb(158, 158, 158, 0.6)', height: 50 / proporcional,
                    ...
                    <input 
                        ...
                        type='number'
                        className='form-control'
                        style={{width: 275.5 / proporcional, height: 50 / proporcional, border: `1px solid rgb(158,158,158, 0.6)`, borderRadius: 8 / proporcional,
                            background: 'white', fontSize: 16 / proporcional, marginLeft: 10 / proporcional}}
                ...
                <div className={`d-flex justify-content-${editar_info ? 'between' : 'end'}`}>
                    {
                        editar_info ? (
                            <button className='btn' style={{width: editar_info ? 275.5 / proporcional : 285.5 / proporcional, height: 50 / proporcional, background: boton_cancelar ? '#384da7' : 'white', 
                    ...
                    <button className='btn' style={{width: editar_info ? 275.5 / proporcional : 275.5 / proporcional, height: 50 / proporcional, background: boton_guardar ? 'white' : '#384da7', 
