        ...
        <div style={{background: 'white', width: 600 / proporcional, marginBottom: 20 / proporcional}}>
            <div style={{width: 600 / proporcional}}>
                ...
                <div className={`d-flex justify-content-${editar_info ? 'between' : 'end'}`}>
                    {
                        editar_info ? (
                            <button className='btn' style={{width: editar_info ? 290 / proporcional : 300 / proporcional, height: 50 / proporcional, background: boton_cancelar ? '#384da7' : 'white', 
                    ...
                    <button className='btn' style={{width: editar_info ? 290 / proporcional : 290 / proporcional, height: 50 / proporcional, background: boton_guardar ? 'white' : '#384da7', 
