...
export default function DataInfoCell({proporcional}) {
  ...
  return (
    <div style={{width: 459 / proporcional, background: 'white', marginLeft: 20 / proporcional, marginRight: 20 / proporcional}}>
        ...
        <div style={{background: 'white', width: 459 / proporcional, marginBottom: 20 / proporcional}}>
            <div style={{width: 459 / proporcional}}>
                <div className='d-flex' style={{width: 459 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <input 
                        ...
                        style={{width: 459 / proporcional, height: 50 / proporcional, border: `1px solid ${enombres ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                            background: 'white', fontSize: 16 / proporcional}}
                    ...
                    <input 
                        ...
                        disabled={!editar_info}
                        className='form-control'
                        style={{width: 459 / proporcional, height: 50 / proporcional, border: `1px solid ${eapellidos ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                            background: 'white', fontSize: 16 / proporcional}}
                ...
                <div className='d-flex' style={{width: 459 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <input 
                        ...
                        type='number'
                        className='form-control'
                        style={{width: 459 / proporcional, height: 50 / proporcional, border: `1px solid ${enro_telefono ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                            background: 'white', fontSize: 16 / proporcional}}
                ...
                <div className='d-flex' style={{width: 459 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <input 
                        ...
                        disabled={true}
                        className='form-control'
                        style={{width: 459 / proporcional, height: 50 / proporcional, border: `1px solid ${eemail ? 'red' : 'rgb(158,158,158, 0.6)'}`, borderRadius: 8 / proporcional,
                ...
                <div className='d-flex' style={{width: 459 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <select
                        disabled={!editar_info}
                        style={{width: 459 / proporcional, border: '1px solid rgb(158, 158, 158, 0.6)', height: 50 / proporcional,
                ...
                <div className='d-flex' style={{width: 459 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <input 
                        ...
                        type='number'
                        className='form-control'
                        style={{width: 459 / proporcional, height: 50 / proporcional, border: `1px solid rgb(158,158,158, 0.6)`, borderRadius: 8 / proporcional,
                            background: 'white', fontSize: 16 / proporcional}}
