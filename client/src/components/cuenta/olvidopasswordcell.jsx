...
import TituloPaginaCell from './olvido/tituloprincipalcell.jsx'
import IngresarEmailCell from './ingresaremailcell.jsx'
...
export default function OlvidoPasswordCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <IngresarEmailCell proporcional={proporcional}/>
