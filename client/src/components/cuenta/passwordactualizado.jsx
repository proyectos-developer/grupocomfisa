...
import TituloPagina from './actualizado/tituloprincipal.jsx'
import ActualizacionCorrecta from './actualizacionaorrecta.jsx'
import FooterPrincipal from '../footerprincipal.jsx'
import Footer from '../footer.jsx'
import ModalCargando from '../modal/cargando.jsx'
import { useSelector } from 'react-redux'

export default function PasswordActualizado({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <ActualizacionCorrecta proporcional={proporcional}/>
