...
import TituloPaginaTablet from './confirmacion/tituloprincipaltablet.jsx'
import ConfirmacionCorreoTablet from './confirmacioncorreotablet.jsx'
...
export default function OlvidoPasswordTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <ConfirmacionCorreoTablet proporcional={proporcional}/>
