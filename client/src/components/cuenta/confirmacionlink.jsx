...
import TituloPagina from './confirmacion/tituloprincipal.jsx'
import ConfirmacionCorreo from './confirmacioncorreo.jsx'
import FooterPrincipal from '../footerprincipal.jsx'
import Footer from '../footer.jsx'
import ModalCargando from '../modal/cargando.jsx'
import { useSelector } from 'react-redux'

export default function ConfirmacionLink({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <ConfirmacionCorreo proporcional={proporcional}/>
