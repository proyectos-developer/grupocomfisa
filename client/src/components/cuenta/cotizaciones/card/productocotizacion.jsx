    ...
    return (
        <div className='border shadow-sm' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional,
            ...
            <div className='d-flex' style={{width: '100%', height: 'auto',
                ...
                <div className='d-flex justify-content-center' style={{width: '10%', height: 'auto', borderRight: '2px solid #384da7', padding: 10 / proporcional}}>
                    <img src={producto.foto_uno} style={{width: 40, height: 40 / proporcional}}/>
                </div> 
                <div style={{width: '40%', height: 'auto', borderRight: '2px solid #384da7', padding: 10 / proporcional}}>
                ...
                <div style={{width: '10%', height: 'auto', borderRight: '2px solid #384da7', padding: 10 / proporcional}}>
                    <p style={{fontSize: 14 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0, color: '#212121', fontWeight: 500}}>
                        Cantidad: 
                    </p>
                ...
                <div style={{width: '40%', height: 'auto',  padding: 10 / proporcional}}>
                    <p style={{fontSize: 14 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0, color: '#212121', fontWeight: 500}}>
                        Comentarios: 
                    </p>
                    <p style={{fontSize: 16 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0, color: '#212121', fontWeight: 600}}>
            ...
            <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '20%', height: 'auto', borderRight: '2px solid #384da7', padding: 10 / proporcional}}>
