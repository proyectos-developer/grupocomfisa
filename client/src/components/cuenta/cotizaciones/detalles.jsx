...
import TituloPaginaProductos from './tituloprincipalproductos.jsx'
import ListaProductos from './listaprouctos.jsx'
...
export default function DetallesCotizacionCuenta({proporcional}) {

    const begin = useSelector (({begin_data}) => begin_data)

    return (
        <div style={{width: '100%'}}>
            <TituloPaginaProductos proporcional={proporcional}/>
