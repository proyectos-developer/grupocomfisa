...
import ListaCotizacionesTablet from './cotizacionestablet.jsx'
...
export default function CotizacionesCuentaTablet({proporcional}) {
        ...
        <div style={{width: '100%'}}>
            ...
            <div className='d-flex' style={{width: 871 / proporcional, height: 'auto', marginLeft: 60 / proporcional, marginRight: 60 / proporcional, 
                ...
                <div style={{width: 571 / proporcional, height: 'auto'}}>
                    <ListaCotizacionesTablet proporcional={proporcional}/>
                </div>
            </div>
