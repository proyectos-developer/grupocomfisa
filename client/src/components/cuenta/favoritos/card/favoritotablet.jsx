...
export default function CardFavoritoTablet({proporcional, favorito, total, index}) {
    ...
    return (
        loading === 2 ? (
            <div className='d-flex' style={{width: 571 / proporcional, padding: 10 / proporcional, height: 70 / proporcional,
