...
export default function CardFavorito({proporcional, favorito, total, index}) {
    ...
    return (
        loading === 2 ? (
            <div className='d-flex' style={{width: 598 / proporcional, padding: 10 / proporcional, height: 70 / proporcional,
                ...
                <div style={{width: 458 / proporcional, height: 50 / proporcional}}>
