...
import ListaFavoritosTablet from './favoritostablet.jsx'
...
export default function FavoritosCuentaTablet({proporcional}) {
        ...
        <div style={{width: '100%'}}>
            ...
            <div className='d-flex' style={{width: 871 / proporcional, height: 'auto', marginLeft: 60 / proporcional, marginRight: 60 / proporcional, 
                ...
                <div style={{width: 571 / proporcional, height: 'auto'}}>
                    <ListaFavoritosTablet proporcional={proporcional}/>
                </div>
            </div>
