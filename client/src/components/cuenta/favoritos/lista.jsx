...
export default function FavoritosCuenta({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <div className='d-flex' style={{width: 900 / proporcional, height: 'auto', marginLeft: 510 / proporcional, marginRight: 510 / proporcional, 
                    marginBottom: 60 / proporcional}}>
                <div style={{width: 300 / proporcional, height: 'auto'}}>
                    <MenuCuenta proporcional={proporcional}/>
                </div>
                <div style={{width: 600 / proporcional, height: 'auto'}}>
                    <ListaFavoritos proporcional={proporcional}/>
                </div>
            </div>
