...
export default function FormularioContactoTablet({proporcional}) {
    ...
    return (
        <div style={{width: 871 / proporcional, marginRight: 60 / proporcional, marginLeft: 60 / proporcional}}>
            ...
            <div style={{width: 871 / proporcional, marginBottom: 20 / proporcional}}>
