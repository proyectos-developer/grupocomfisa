...
export default function InformacionContactoCell({proporcional}) {

    return (
        <div style={{width: 459 / proporcional, marginRight: 20 / proporcional, marginLeft: 20 / proporcional, marginTop: 20 / proporcional}}>
