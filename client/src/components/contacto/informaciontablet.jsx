...
export default function InformacionContactoTablet({proporcional}) {
    ...
    return (
        <div style={{width: 871 / proporcional, marginRight: 60 / proporcional, marginLeft: 60 / proporcional, marginTop: 20 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', marginTop: 15 / proporcional, marginBottom: 33 / proporcional}}>
                <div className='d-flex' style={{width: '49%', marginTop: 15 / proporcional, marginBottom: 33 / proporcional}}>
