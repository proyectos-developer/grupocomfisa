        ...
        <div style={{background: 'white', width: '100%', paddingLeft: 350 / proporcional, paddingRight: 350 / proporcional}}>
            ...
            <div style={{background: 'white', width: 1200 / proporcional, paddingTop: 57 / proporcional, paddingBottom: 57 / proporcional}}>
                ...
                <div className='d-flex justify-content-start' style={{width: 1200 / proporcional, marginBottom: 34 / proporcional, height: 'auto'}}>
                    <CardProveedor proporcional={proporcional} id={lista_proveedores[12].id} titulo={lista_proveedores[12].titulo} subtitulo={lista_proveedores[12].subtitulo} descripcion={lista_proveedores[9].descripcion}  icono={lista_proveedores[12].icono} logo={lista_proveedores[12].logo}/>
                    <CardProveedor proporcional={proporcional} id={lista_proveedores[13].id} titulo={lista_proveedores[13].titulo} subtitulo={lista_proveedores[13].subtitulo} descripcion={lista_proveedores[9].descripcion}  icono={lista_proveedores[13].icono} logo={lista_proveedores[13].logo}/>
                </div>
            </div>
        </div>
    )
