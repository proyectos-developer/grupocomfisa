...
export default function ProductosProveedores({proporcional}) {
    ...
    const lista_proveedores = [
        {id: '15', subtitulo: 'ACEROS AREQUIPA', titulo: 'BARRAS CORRUGADAS', descripcion: 'Se utiliza en la construcción de edificaciones de concreto armado de todo tipo: en viviendas, edificios, puentes, obras industriales, etc.', icono: icono_varilla, logo: varillas},
        {id: '30', subtitulo: 'INKAFERRO', titulo: 'BARRAS CORRUGADAS', descripcion: 'Las barras corrugadas ArcelorMital ASTM A615/A615m grado 60 se emplea como acero de refuerzo para todo tipo de obra: viviendas, edificaciones, centros comerciales y obras de gran envergadura...', icono: icono_varilla_1, logo: varillas_1},
        {id: '17', subtitulo: 'METALYCK', titulo: 'ALAMBRE RECOCIDO', descripcion: '', icono: icono_alambre, logo: alambre},
        {id: '26', subtitulo: 'ACEROS AREQUIPA', titulo: 'CLAVO DE ALBAñILERÍA', descripcion: 'En todo tipo de construcciones y trabajos en madera.', icono: icono_clavos, logo: clavos},
        ...
        {id: '31', subtitulo: 'SAGITARIO', titulo: 'LADRILLOS', descripcion: 'Los ladrillos se utiliazan en construcción para cerramientos, fachadas y particiones. Se utiliza principalemnte para construir muros o tabiques. Aunque se pueden colocar a hueso, lo habitual es que se reciban con mortero.', icono: icono_ladrillos_1, logo: ladrillos_1},
    ...
    return (
        <div style={{background: 'white', width: '100%', paddingLeft: 350 / proporcional, paddingRight: 350 / proporcional}}>
            ...
            <div style={{background: 'white', width: 1200 / proporcional, paddingTop: 57 / proporcional, paddingBottom: 57 / proporcional}}>
                ...
                <div className='d-flex justify-content-start' style={{width: 1200 / proporcional, marginBottom: 34 / proporcional, height: 'auto'}}>
