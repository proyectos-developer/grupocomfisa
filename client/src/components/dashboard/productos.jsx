...
export default function ProductosProveedores({proporcional}) {
    ...
    const lista_proveedores = [
        ...
        {titulo: 'INKAFERRO', subtitulo: 'BARRAS CORRUGADAS ARCELORMITTAL', descripcion: 'Se utiliza como material de refuerzo en las construcciones de concreto armado. Debido a sus características y propiedades posee un función esencial en la construcción de obras de infraestructura, de vivienda, comerciales e industriales.', icono: icono_varilla_1, logo: varillas_1},
        ...
        <div style={{background: 'white', width: '100%', paddingLeft: 350 / proporcional, paddingRight: 350 / proporcional}}>
            ...
            <div style={{background: 'white', width: 1200 / proporcional, paddingTop: 57 / proporcional, paddingBottom: 57 / proporcional}}>
                ...
                <div className='d-flex justify-content-start' style={{width: 1200 / proporcional, marginBottom: 34 / proporcional, height: 'auto'}}>
                    ...
                    <CardProveedor proporcional={proporcional} titulo={lista_proveedores[13].titulo} subtitulo={lista_proveedores[13].subtitulo} descripcion={lista_proveedores[9].descripcion}  icono={lista_proveedores[13].icono} logo={lista_proveedores[13].logo}/>
                </div>
            </div>
        </div>
    )
