        ...
        <div id="carouselHome" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
                <div className="carousel-item active" data-bs-interval="3000">
                    <img src={fondo_home_0} style={{width: '100%', height: 600 / proporcional}}/>
                </div>
                <div className="carousel-item" data-bs-interval="3000">
                    <img src={fondo_home_1} style={{width: '100%', height: 600 / proporcional}}/>
                </div>
                <div className="carousel-item" data-bs-interval="3000">
                    <img src={fondo_home_2} style={{width: '100%', height: 600 / proporcional}}/>
                </div>
            </div>
