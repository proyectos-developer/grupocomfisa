...
import varillas from '../../assets/productos/aceros_arequipa_427.png'
import varillas_1 from '../../assets/productos/varillas_1_427.png'
import tecnopor from '../../assets/productos/tecnopor_427.png'
import clavos from '../../assets/productos/aceros_arequipa_1_427.png'
import clavos_1 from '../../assets/productos/clavos_1_427.png'
import alambre from '../../assets/productos/metalyck_427.png'
import sellador from '../../assets/productos/sellador_427.png'
import cemento from '../../assets/productos/cemento_427.png'
import ladrillos from '../../assets/productos/piramide_427.png'
import ladrillos_1 from '../../assets/productos/saguitario_427.png'
import guantes from '../../assets/productos/comfisa_427.png'
import tubos from '../../assets/productos/tubos_427.png'
import barras from '../../assets/productos/siderperu_427.png'
...
export default function ProductosProveedoresCell({proporcional}) {
    ...
    const lista_proveedores = [
        ...
        {id: '3', subtitulo: 'SIDERPERU', titulo: 'BARRAS CONSTRUCCIÓN', descripcion: `Las barras de refuerzo, también conocidas como barras corrugadas, son usadas como refuerzo en elemento de concreto armado, por su alta adherencia con el concreto debido a que cuenta con corrugas o resaltes tipo Hight-Bond`, icono: icono_barras, logo: barras},

        {id: '4', subtitulo: 'METALYCK', titulo: 'ALAMBRE RECOCIDO', descripcion: `Alambres lisos de acero de bajo carbono laminados y/o trefilado, sometido a tratamiento térmico de recocido para aumentar su ductilidad, usados en la construcción civil en el armado de estructuras y amarre de encofrados.`, icono: icono_alambre, logo: alambre},

        {id: '5', subtitulo: 'ACEROS AREQUIPA', titulo: 'CLAVO DE ALBAÑILERÍA', descripcion: `El acero nace de la fusión de diferentes cargas metálicas, con contenido de hierro, ferroaleaciones y carbono, las cuales determinan su estructura molecular pero este proceso no es tan simple como parece. Para conocerlo, explicaremos el proceso de producción de Corporación Aceros Arequipa, empresa peruana líder en la fabricación y comercialización de productos de acero en el Perú, el cual cuenta con dos sedes productivas.`, icono: icono_clavos, logo: clavos},

        {id: '6', subtitulo: 'TREAMPERÚ', titulo: 'CLAVO DE ALBAÑILERÍA', descripcion: `En Tream Perú nos caracterizamos por ofrecer productos fabricados bajo estándares de calidad que nos diferencian de la competencia y nos permiten responder a las necesidades del mercado. Los clavos se dividen según sea el sector, Tream Perú fabrica clavos destinados a 4 sectores específicos: albañil, carpintero, frutero y minero.`, icono: icono_clavos_1, logo: clavos_1},

        {id: '7', subtitulo: 'PIRAMIDE', titulo: 'LADRILLOS', descripcion: `Los ladrillos se utilizan en construcción para fachadas y particiones. Se utiliza principalmente para construir muros o tabiques. Aunque se pueden colocar a hueso, lo habitual es que se reciban con mortero.`, icono: icono_ladrillos, logo: ladrillos},

        {id: '8', subtitulo: 'SAGUITARIO', titulo: 'LADRILLOS', descripcion: `La implementación de los ladrillos es lo último en maquinaria totalmente automatizada, lo que nos permite no sólo mejorar la fabricación de productos con arcilla microcompacta, de altísima durabilidad, sino también incursionar en la elaboración de materiales bajo patrones europeos de calidad.`, icono: icono_ladrillos_1, logo: ladrillos_1},

        {id: '9', subtitulo: 'INKA', titulo: 'CEMENTO', descripcion: `El cemento es un material de construcción esencial; de hecho, es el más utilizado en el mundo. La mayoría de las construcciones lo emplean en, por lo menos, una de sus etapas: cimientos, suelos, dinteles, muros, paredes o techos.`, icono: icono_cemento, logo: cemento},

        {id: '10', subtitulo: 'ETSAPERÚ', titulo: 'PLANCHAS TECNOPOR', descripcion: `El Tecnopor es utilizado en el sector de las obras civiles y construcción, en techos y paredes para el aislamiento térmico y acústico.`, icono: icono_planchas, logo: tecnopor},

        {id: '11', subtitulo: 'MAJESTAD', titulo: 'SELLADOR', descripcion: `Puede utilizarse para el pintado de cielos rasos, cercos perimétricos, jardines, y como señalización en postesEl temple es uno de los productos más utilizado tradicionalmente para pintar paredes. Hasta la aparición de las modernas pinturas plásticas, era el material más cómodo y barato de utilizar.`, icono: icono_sellado, logo: sellador},
        ...
        {id: '14', subtitulo: 'COMFISA', titulo: 'GUANTES', descripcion: `Guante reforzador de nitrilo en la palma para proteger contra cortes leves. De fácil manipulación y flexible. Ajuste elástico para la muñeca.`, icono: icono_guantes, logo: guantes},

        {id: '15', subtitulo: 'ASA', titulo: 'LIJAS', descripcion: `Las lijas suelen usarse para dejar lisas las paredes, previo al pintado. Las lijas también se utilizan en carpintería, para el acabado de diferentes piezas.`, icono: icono_lija, logo: lijas},

        {id: '16', subtitulo: 'MATUSITA', titulo: 'TUBOS Y CONEXIONES', descripcion: `Nuestros productos operan en los segmentos de hidráulica, eléctrica, drenaje, accesorios sanitarios, infraestructura, industria, riego, herramientas de pintura, metales sanitarios y en soluciones para aguas y efluentes en el tratamiento de reutilización de aguas.`, icono: icono_tubo, logo: tubos}
    ]
    ...
    return (
        <div style={{background: 'white', width: '100%', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            ...
            <div style={{background: 'white', width: '100%', paddingTop: 57 / proporcional, paddingBottom: 57 / proporcional}}>
                ...
                <CardProveedorCell proporcional={proporcional} id={lista_proveedores[15].id} titulo={lista_proveedores[15].titulo} subtitulo={lista_proveedores[15].subtitulo} descripcion={lista_proveedores[15].descripcion}  icono={lista_proveedores[15].icono} logo={lista_proveedores[15].logo}/>
            </div>
        </div>
    )
}