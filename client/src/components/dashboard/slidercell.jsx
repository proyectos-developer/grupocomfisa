...
import fondo_home_1 from '../../assets/images/fondo_home_cell_0.png'
import fondo_home_0 from '../../assets/images/fondo_home_cell_1.png'
import fondo_home_2 from '../../assets/images/fondo_home_cell_2.png'
            ...
            <div className="carousel-inner">
                ...
                <div className="carousel-item animate__animated animate__fadeIn" data-bs-interval="3000"
                    style={{backgroundImage: `url(${fondo_home_1})`, width: '100%', height: 750 / proporcional, backgroundRepeat: 'no-repeat',
                        backgroundPosition: 'center', backgroundSize: 'cover'}}>
                    <div className='position-relative' style={{width: '100%', height: 750 / proporcional, background: 'rgba(56, 77, 167, 0.4)'}}> 
                        <div className='position-absolute animate__animated animate__backInUp' style={{width: '70%', height: 500 / proporcional, top: 150 / proporcional, left: '20%'}}>
                            <img src={logo_comfisa} style={{width: 200 / proporcional, height: 73 / proporcional, marginBottom: 20 / proporcional}}/>
                            <p style={{fontSize: 40 / proporcional, lineHeight: `${50 / proporcional}px`, fontWeight: 600, marginBottom: 20 / proporcional, color: 'white'}}>
                                NOS BENEFICIAMOS EN 
                            </p>  
                            <p style={{fontSize: 40 / proporcional, lineHeight: `${50 / proporcional}px`, fontWeight: 600, marginBottom: 20 / proporcional, color: '#007BA7'}}>
                                PRECIO Y RAPIDEZ
                            </p>
                            <p style={{fontSize: 40 / proporcional, lineHeight: `${50 / proporcional}px`, fontWeight: 600, marginBottom: 20 / proporcional, color: 'white'}}>
                                DE ENTREGA
                ...
                <div className="carousel-item animate__animated animate__bounceInRight" data-bs-interval="3000"
                    style={{backgroundImage: `url(${fondo_home_2})`, width: '100%', height: 750 / proporcional, backgroundRepeat: 'no-repeat',
                        backgroundPosition: 'center', backgroundSize: 'cover'}}>
                    <div className='position-relative' style={{width: '100%', height: 750 / proporcional, background: 'rgba(56, 77, 167, 0.4)'}}> 
                        <div className='position-absolute animate__animated animate__bounceIn' style={{width: '70%', height: 500 / proporcional, top: 150 / proporcional, left: '15%'}}>
                            <img src={logo_comfisa} style={{width: 200 / proporcional, height: 73 / proporcional, marginBottom: 20 / proporcional}}/>
                            <p style={{fontSize: 40 / proporcional, lineHeight: `${50 / proporcional}px`, fontWeight: 600, marginBottom: 20 / proporcional, color: 'white'}}>
