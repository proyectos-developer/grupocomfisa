...
export default function CardProveedorTablet({proporcional, id, titulo, subtitulo, descripcion, icono, logo}) {
    ...
    return (
        <div style={{width: 405.5 / proporcional, marginBottom: 37 / proporcional, marginRight: 15 / proporcional, marginLeft: 15 / proporcional}}>
            <div className='position-relative' style={{width: 405.5 / proporcional, height: 304 / proporcional, marginBottom: 15 / proporcional, border: '1px solid #ededed', cursor: 'default'}}
                onMouseOver={() => setSeleccionProducto ('norton')} onMouseLeave={() => setSeleccionProducto('')}>
                {
                    logo !== null ? (
                        <img src={logo} style={{width: 403.5 / proporcional, height: 302 / proporcional}}/>
                    ) : null
                }
                <div className={`position-absolute top-0 start-0 ${seleccion_producto === 'norton' ? 'animate__animated animate__backInDown' : 'animate__animated animate__bounceOut'}`} 
                    style={{width: 405.5 / proporcional, height: 304 / proporcional, background: '#007BA7',
                            padding: 10}}>
            ...
            <div className='d-flex' style={{width: 403.5 / proporcional, cursor: 'pointer'}} onClick={() => {ver_productos_proveedor(); window.scrollTo(0, 0)}}>
