...
export default function CardProveedor({proporcional, id, titulo, subtitulo, descripcion, icono, logo}) {
    ...
    return (
        <div style={{width: 370 / proporcional, marginRight: 15 / proporcional, marginLeft: 15 / proporcional}}>
            ...
            <div className='d-flex' style={{width: 370 / proporcional, cursor: 'pointer'}} onClick={() => {ver_productos_proveedor(); window.scrollTo(0, 0)}}>
                ...
                <div style={{width: 292 / proporcional, height: 'auto'}}>
                    <p style={{fontSize: 24 / proporcional, lineHeight: `${39 / proporcional}px`, color: '#292929', fontWeight: 500, marginBottom: 0}}>
                        {titulo}
                    </p>
