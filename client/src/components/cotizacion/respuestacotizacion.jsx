...
import CardProductoRepusta from './card/productorespuesta.jsx'
...
export default function LitaRespuetaCotizacion({proporcional}) {
                ...
                </div>
                {
                    lista_cotizar && lista_cotizar.length > 0 ?(
                        lista_cotizar.map ((producto, index) => {
                            return (
                                <CardProductoRepusta producto={producto} proporcional={proporcional}/>
                            )
                        })
                    ) : null
                }
