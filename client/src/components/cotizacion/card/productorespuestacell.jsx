...
export default function CardProductoRepustaCell({producto, proporcional}) {
    ...
    return (
            loading === 2 ? (
                <div className='' style={{width: '100%', height: 'auto', border: '1px solid #e8e8e8', marginBottom: 10 / proporcional}}>
                    <div className='' style={{width: '100%', height: 'auto', border: '1px solid #e8e8e8'}}>
                        <div className='d-flex' style={{width: '100%', height: 131 / proporcional, border: '1px solid #e8e8e8'}}>
                            <div className='d-flex' style={{width: '70%', height: 129 / proporcional, padding: 15 / proporcional}}>
                                ...
                                <div style={{marginLeft: 30 / proporcional, width: 201 / proporcional}}>
                                    ...
                                    <p style={{fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, fontWeight: 500, marginBottom: 0, color: 'rgb(34, 34, 34)'}}>
                                        {nombre_producto}
                                    </p>
                                </div>
                            </div>
                            <div className='d-flex justify-content-center' style={{width: '30%', height: 129 / proporcional, padding: 15 / proporcional}}>
                                <input 
                                    disabled={true}
                                type='number'
                                ...
                                placeholder='1'
                                style={{fontSize: 16 / proporcional, width: '80%', height: 50 / proporcional, 
                                        marginTop: 24.5 / proporcional, marginBottom: 24.5 / proporcional, background: '#f8f9f9', 
                                        color: '#848a90', textAlign: 'center'}}/>
                            </div>
                        </div>
                        <div style={{width: '100%', height: 129 / proporcional, padding: 15 / proporcional}}>
                            <textarea 
                                disabled={true}
                            type='default'
                            cols={3}
