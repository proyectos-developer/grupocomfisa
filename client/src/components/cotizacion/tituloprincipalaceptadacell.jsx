...
export default function TituloPrincipalAceptadaTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', background: '#f5f6f6', height: 70 / proporcional, paddingTop: 20 / proporcional, paddingBottom: 20 / proporcional,
            ...
            <div className='d-flex justify-content-between' style={{width: '100%'}}>
                <p style={{fontSize: 22 / proporcional, fontWeight: 500, color: '#292929', marginBottom: 0, cursor: 'default'}}>COTIZACIÓN ACEPTADA</p>
