                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                    <div className='' style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                            <div style={{width: '49%', height: 150 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_uno)}>
                                {
                                    foto_uno === '' ? (
                            ...
                            <div style={{width: '49%', height: 150 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_dos)}>
                                {
                                    foto_dos === '' ? (
                                        <div style={{width: '100%', height: '100%'}}/>
                                    ): (
                        ...
                        <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                            <div style={{width: '49%', height: 150 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_tres)}>
                                {
                                    foto_tres === '' ? (
                                        <div style={{width: '100%', height: '100%'}}/>
                                    ): (
                            ...
                            <div style={{width: '49%', height: 150 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_cuatro)}>
                                {
                                    foto_cuatro === '' ? (
                                        <div style={{width: '100%', height: '100%'}}/>
                                    ): (
