...
export default function InformacionProveedorCell({proporcional}) {
        ...
        <div style={{width: '100%', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional}}>
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                {
                    foto_principal && foto_principal !== '' ? (
                        <ReactImageZoom {...{ width: '459', height: 459 / proporcional, img: foto_principal, zoomPosition: 'original', zoomWidth: 500, zoomLensStyle: 'default',
                        zoomStyle: 'default', offset: 'default'}}/>
                    ) : (
                        <div style={{width: '459', height: 459 / proporcional, marginRight: 10 / proporcional, border: '1px solid #bdbdbd'}}/>
                    )
                }
            </div>
            <div style={{width: '100%', height: 459 / proporcional}}>
            ...
            <div className='' style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                    <div style={{width: '49%', height: 224.91 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_uno)}>
                        {
                            foto_uno === '' ? (
                    ...
                    <div style={{width: '49%', height: 224.91 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_dos)}>
                        {
                            foto_dos === '' ? (
                                <div style={{width: '100%', height: '100%'}}/>
                            ): (
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                    <div style={{width: '49%', height: 224.91 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_tres)}>
                        {
                            foto_tres === '' ? (
                                <div style={{width: '100%', height: '100%'}}/>
                            ): (
                    ...
                    <div style={{width: '49%', height: 224.91 / proporcional, cursor: 'pointer'}} onClick={() => setFotoPrincipal(foto_cuatro)}>
                        {
                            foto_cuatro === '' ? (
                                <div style={{width: '100%', height: '100%'}}/>
                            ): (
