...
import TituloPaginaTablet from './tituloprincipaltablet';
import InformacionProveedorTablet from './informaciontablet.jsx'
...
export default function ProveedorProductosTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <InformacionProveedorTablet proporcional={proporcional}/>
