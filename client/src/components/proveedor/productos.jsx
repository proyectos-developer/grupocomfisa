...
import TituloPagina from './tituloprincipal';
import InformacionProveedor from './informacion.jsx'
...
export default function ProveedorProductos({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <InformacionProveedor proporcional={proporcional}/>
