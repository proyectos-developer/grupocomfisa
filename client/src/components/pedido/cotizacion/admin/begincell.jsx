...
import TituloPedidoCell from './titulopedidocell.jsx'
import DatosClienteCell from './datosclientecell.jsx'
import ListaProductosCell from './listaproductoscell.jsx'
...
export default function CotizacionParaAdminTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <TituloPedidoCell proporcional={proporcional} nro_pedido={nro_pedido} fecha_pedido={fecha_pedido}/>
            <div style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
                <DatosClienteCell proporcional={proporcional} usuario={usuario}/>
                <ListaProductosCell proporcional={proporcional} productos={productos}/>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 50 / proporcional}}>
                    <button className='btn' style={{width: '90%', height: 50 / proporcional, fontSize: 20 / proporcional, background: boton_enviar ? 'transparent' : '#8B4513', 
