...
import CotizacionEnviadaCell from './cotizacionenviadacell.jsx'
...
export default function PedidoEnviadoCell({proporcional}) {
    ...
    return (
        <div tyle={{width: '100%', height: 'auto'}}>
            ...
            <CotizacionEnviadaCell proporcional={proporcional}/>
        </div>
    )
}