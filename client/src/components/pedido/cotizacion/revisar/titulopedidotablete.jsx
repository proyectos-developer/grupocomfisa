...
export default function TituloPedidoTablete({proporcional, nro_pedido, fecha_pedido}) {

    const navigate = useNavigate()

    return (
        <div className='' style={{width: '100%', height: 176 / proporcional, paddingLeft: 60 / proporcional,  paddingRight: 60 / proporcional,
