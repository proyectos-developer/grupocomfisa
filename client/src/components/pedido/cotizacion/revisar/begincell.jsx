...
import TituloPedidodCell from './titulopedidocell.jsx'
import DatosClientedCell from './datosclientecell.jsx'
import ListaProductosdCell from './listaproductoscell.jsx'
...
export default function CotizacionDelClienteCell({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: 'auto'}}>
            <TituloPedidodCell proporcional={proporcional} nro_pedido={nro_pedido} fecha_pedido={fecha_pedido}/>
            <div style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
                <DatosClientedCell proporcional={proporcional} usuario={usuario}/>
                <ListaProductosdCell proporcional={proporcional} productos={productos}/>
            </div>
