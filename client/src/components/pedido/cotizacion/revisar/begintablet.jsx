...
import TituloPedidoTablet from './titulopedidotablete.jsx'
import DatosClienteTablet from './datosclientetablete.jsx'
import ListaProductosTablet from './listaproductostablete.jsx'
...
export default function CotizacionDelClienteTablet({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                <DatosClienteTablet proporcional={proporcional} usuario={usuario}/>
                <ListaProductosTablet proporcional={proporcional} productos={productos}/>
            </div>
