...
export default function TituloPedido({proporcional, nro_pedido, fecha_pedido}) {

    const navigate = useNavigate()

    return (
        <div className='' style={{width: '100%', height: 120 / proporcional, paddingLeft: 350 / proporcional,  paddingRight: 350 / proporcional,
            ...
            <div className='d-flex justify-content-between' style={{height: 64 / proporcional, borderBottom: '2px solid #fafafa'}}>
                <div className='d-flex justify-content-start' style={{height: 64 / proporcional, borderBottom: '2px solid #fafafa'}}>
                    <p style={{fontSize: 20 / proporcional, lineHeight: `${64 / proporcional}px`, marginBottom: 0, color: '#212121', fontWeight: 400}}>
                        Número de pedido: <span style={{fontSize: 24 / proporcional, fontWeight: 600, color: '#007BA7'}}>{nro_pedido}</span>
                    </p>
                </div>
                <div className='d-flex justify-content-end' style={{height: 64 / proporcional, borderBottom: '2px solid #fafafa'}}>
                    <p style={{fontSize: 20 / proporcional, lineHeight: `${64 / proporcional}px`, marginBottom: 0, color: '#212121', fontWeight: 400}}>
                        Fecha de pedido: <span style={{fontSize: 24 / proporcional, fontWeight: 600, color: '#007BA7'}}>{fecha_pedido.split('T')[0]}</span>
                    </p>
                </div>
            </div>
        </div>
