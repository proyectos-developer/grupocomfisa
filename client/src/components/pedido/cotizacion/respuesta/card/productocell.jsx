...
export default function ProductoCell({proporcional, producto}) {
    ...
    return (
        <div className='shadow rounded' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
            ...
            <div className='d-flex' style={{width: '100%', height: 100 / proporcional, padding: 10 / proporcional}}>
                <div className='' style={{width: '20%', height: 80 / proporcional, borderRight: '1px solid #efefef', paddingLeft: 10 / proporcional}}>
                ...
                <div className='' style={{width: '80%', height: 80 / proporcional, paddingLeft: 10 / proporcional}}>
