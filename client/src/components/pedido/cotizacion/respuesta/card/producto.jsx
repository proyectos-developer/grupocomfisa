...
export default function Producto({proporcional, producto}) {
        ...
        <div className='shadow rounded' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
            <div className='d-flex' style={{width: '100%', height: 100 / proporcional, padding: 10 / proporcional}}>
                ...
                <div className='' style={{width: '65%', height: 80 / proporcional, paddingLeft: 10 / proporcional}}>
                    <p style={{fontSize: 14 / proporcional, lineHeight: `${16 / proporcional}px`, marginBottom: 0, color: '#007BA7', fontWeight: 600}}>
                        Comentarios:
                    </p>
            ...
            <div className='d-flex' style={{width: '100%', height: 100 / proporcional, padding: 10 / proporcional}}>
                ...
                <div className='' style={{width: '15%', height: 80 / proporcional, borderRight: '1px solid #efefef', paddingLeft: 10 / proporcional}}>
                ...
                <div className='' style={{width: '75%', height: 80 / proporcional, borderRight: '1px solid #efefef', paddingLeft: 10 / proporcional}}>
                    <p style={{fontSize: 14 / proporcional, lineHeight: `${16 / proporcional}px`, marginBottom: 0, color: '#007BA7', fontWeight: 600}}>
                        Observaciones:
                    </p>
                    <p style={{fontSize: 16 / proporcional, lineHeight: `${18 / proporcional}px`, marginBottom: 0, color: '#212121', fontWeight: 500}}>
