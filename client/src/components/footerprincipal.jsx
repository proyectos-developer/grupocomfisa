...
export default function FooterPrincipal({proporcional}) {
  ...
  return (
    <div style={{width: '100%', paddingLeft: 350 / proporcional, paddingRight: 350 / proporcional, paddingBottom: 50 / proporcional}}>
        <div className='d-flex' style={{width: 1200 / proporcional}}>
            <div style={{width: 300 / proporcional, paddingRight: 15 / proporcional, paddingTop: 10 / proporcional}}>
            ...
            <div style={{width: 300 / proporcional, paddingRight: 15 / proporcional, paddingLeft: 15 / proporcional, paddingTop: 10 / proporcional}}>
                <p style={{fontSize: 22 / proporcional, fontWeight: 500, lineHeight: `${30 / proporcional}px`, marginBottom: 0,
                        color: '#222931', marginBottom: 30 / proporcional}}>Nuestra compañía</p>
                <img src={footer_foto} style={{width: 262 / proporcional, height: 175 / proporcional, marginRight: 4 / proporcional, marginLeft : 4 / proporcional}}/>
            </div>
            <div style={{width: 300 / proporcional, paddingRight: 15 / proporcional, paddingLeft: 15 / proporcional, paddingTop: 10 / proporcional}}>
                <p style={{fontSize: 22 / proporcional, fontWeight: 500, lineHeight: `${30 / proporcional}px`, marginBottom: 0,
            ...
            <div style={{width: 300 / proporcional, paddingLeft: 15 / proporcional, paddingTop: 10 / proporcional}}>
                <p style={{fontSize: 22 / proporcional, fontWeight: 500, lineHeight: `${30 / proporcional}px`, marginBottom: 0,
