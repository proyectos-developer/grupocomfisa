    ...
    <div style={{width: '100%', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional, paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional}}>
      {
        producto && producto.producto ? (
          <div className='d-flex' style={{width: '100%', height: 380 / proporcional}}>
              <img src={producto.foto_uno} style={{width: 380 / proporcional, height: 380 / proporcional, marginRight: 10 / proporcional}}/>
              <div style={{width: 481 / proporcional, height: 380 / proporcional, paddingLeft: 19 / proporcional}}>
                ...
                </p>
                {
                  producto.caracteristica_uno !== '' ? (
                    <div style={{width: 481 / proporcional, height: 'auto'}}>
