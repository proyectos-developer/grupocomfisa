...
export default function InformacionProductoCell({proporcional}) {
  ...
  return (
    <div style={{width: 499 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional}}>
      {
        producto && producto.producto ? (
          <div className='' style={{width: 459 / proporcional, height: 'auto'}}>
              <img src={producto.foto_uno} style={{width: 459 / proporcional, height: 459 / proporcional, marginRight: 10 / proporcional}}/>
