...
export default function CardProductoInformacion({producto, proporcional}) {
            ...
            <div className='position-relative' style={{width: 280 / proporcional}}>
                <div className='d-flex' style={{width: 280 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
                    <p style={{fontSize: 16 / proporcional, fontWeight: 700, lineHeight: `${18 / proporcional}px`, color: '#5f656d', paddingTop: 10 / proporcional,
                        paddingBottom: 10 / proporcional, marginTop: 32 / proporcional, marginBottom: 15 / proporcional, cursor: 'default', marginRight: 5 / proporcional}}>{producto.producto.split(' ')[0]}:</p>
                ...
                <div className={`position-absolute start-0 ${view_opciones ? 'animate__animated animate__bounceIn' : 'top-0 animate__animated animate__bounceOut'}`} 
                    ...
                    <button className='btn' style={{width: 265 / proporcional, background: '#d18e32', height: 50 / proporcional, marginTop: 5 / proporcional,
                        marginBottom: 10 / proporcional, color: 'white', fontWeight: 400, fontSize: 16 / proporcional}}
                        onClick={() => ver_detalles_producto(producto)}>
                        Ver más detalles
                    </button>
                    <div style={{width: 260 / proporcional}} className='d-flex'>
