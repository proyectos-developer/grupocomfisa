      ...
      <div className='' style={{height: 120 / proporcional, paddingLeft: 350 / proporcional,  paddingRight: 350 / proporcional,
        ...
        <div className='position-relative' 
          style={{height: 56 / proporcional, zIndex: 99999, width: '100%', paddingRight: 350 / proporcional, paddingLeft: 350 / proporcional, background: '#f9f9f9'}}>
            <div className='d-flex justify-content-between position-absolute top-0 start-0 rounded' style={{background: '#d18e32', width: 1222 / proporcional}}>
                <div className='d-flex' style={{paddingLeft: 25 / proporcional, background: '#d18e32'}}>
                        ...
                        </div> 
                        {
                          menu === 'proveedor' ? (
                            <div className='position-absolute shadow rounded' 
                                ...
                                <div className='d-flex justiy-content-start' style={{width: 770 / proporcional, height: 'auto', marginBottom: 10 / proporcional}}>
                                  <div style={{width: '25%', height:'auto'}}>
                                      <p style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, fontWeight: 500, cursor: 'default',
                                          marginBottom: 0, color: '#22222'}}>
                                        TIGRE
