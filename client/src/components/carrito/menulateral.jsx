...
import { set_lista_carrito_cotizacion, set_open_menu_carrito } from '../../redux/actions/dataactions';
import { useNavigate } from 'react-router-dom';

import CardProductoMenu from './menu/producto.jsx'
import {carritodata} from '../../redux/slice/carritodata.js';
import { carritoConstants } from '../../uri/carrito-constants.js';

export default function  MenuLateralCarrito({proporcional}) {
            ...
            <div className='overflow-auto' style={{width: '100%', height: 670 / proporcional}}>
                {
                    lista_cotizar && lista_cotizar.length > 0 ? (
                        lista_cotizar.map ((cotizar, index) => {
                            return (
                                <CardProductoMenu cotizar={cotizar} proporcional={proporcional}/>
                            )
                        })
                    ) : null
                }
