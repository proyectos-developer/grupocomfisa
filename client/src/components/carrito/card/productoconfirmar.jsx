...
export default function CardProductoConfirmar({producto, proporcional}) {
    ...
    return (
            loading === 2 ? (
                <div className='d-flex' style={{width: '100%', height: 131 / proporcional, border: '1px solid #e8e8e8'}}>
                    <div className='d-flex' style={{width: 420 / proporcional, height: 129 / proporcional, padding: 15 / proporcional}}>
                        <img src={foto_uno} style={{width: 99 / proporcional, height: 99 / proporcional}}/>
                        <div style={{marginLeft: 30 / proporcional, width: 261 / proporcional}}>
                    ...
                    <div style={{width: 660 / proporcional, height: 129 / proporcional, padding: 15 / proporcional}}>
                        <textarea 
                          type='default'
                          cols={3}
                          disabled={true}
                          ...
                          style={{fontSize: 16 / proporcional, width: 630 / proporcional, height: 99 / proporcional, padding: 10 / proporcional, background: 'white', 
