...
import CardProductoCotizarTablet from './barra/productocotizartablet.jsx'
...
export default function BarraMenu({proporcional}) {
    ...
    return (
      <div className='' style={{width: '100%', height: 120 / proporcional, paddingLeft: 60 / proporcional,  paddingRight: 60 / proporcional,
                                                 background: '#f9f9f9', paddingTop: 4 / proporcional, paddingBottom: 6 / proporcional}}>
        <div className='d-flex justify-content-between' style={{widtth: '100%', height: 56 / proporcional, borderBottom: '2px solid #fafafa'}}>
            ...
            <div className='d-flex justify-content-end' style={{width: '75%', height: 48 / proporcional, paddingTop: 2 / proporcional,
                ...
                <div className='d-flex justify-conten-end'>
                  <div className='d-flex justify-conten-end' style={{paddingRight: 25 / proporcional, borderRight: '1px solid #e6e8e8'}}>
                  ...
                  <div className='d-flex justify-conten-end' style={{paddingLeft: 25 / proporcional}}>
                        ...
                        </div> 
                        {
                          menu === 'proveedor' ? (
                            <div className='position-absolute shadow rounded' 
                                style={{width: 920 / proporcional, height: 'auto', padding: 10 / proporcional, background: 'white', left: -50 / proporcional}}>
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('1'); setMenu('proveedor')}}>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('2'); setMenu('proveedor')}}>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('3'); setMenu('proveedor')}}>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('4'); setMenu('proveedor')}}>
                                ...
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('5'); setMenu('proveedor')}}>
                                      <img className='rounded-2' src={logo_aceros_250} style={{width: '100%'}}/>
                                      <div className='d-flex' style={{height: 30 / proporcional, width: '100%', cursor: 'pointer'}}>
                                          <img src={icono_dot} style={{width: 10 / proporcional, height: 10 / proporcional, marginTop: 10 / proporcional, 
                                                  marginBottom: 10 / proporcional, marginRight: 10 / proporcional}}/>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('6'); setMenu('proveedor')}}>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('7'); setMenu('proveedor')}}>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('8'); setMenu('proveedor')}}>
                                ...
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('9'); setMenu('proveedor')}}>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('10'); setMenu('proveedor')}}>
                                    ...
                                    <div style={{width: '24%', height:'auto', cursor: 'pointer'}}
                                          onClick={() => {ver_productos_proveedor('11'); setMenu('proveedor')}}>
                            ...
                            style={{width: 260 / proporcional, height: 'auto', background: 'transparent', top: 36 / proporcional, right: -20 / proporcional}}>
                              ...
                              <div className='shadow rounded'
                                ...
                                <div className='overflow-auto'
                                  style={{width: 240 / proporcional, height: 300 / proporcional}}>
                                  {
                                    lista_cotizar && lista_cotizar.length > 0 ? (
                                      lista_cotizar.map ((cotizar, index) => {
                                        return (
                                          <CardProductoCotizarTablet cotizar={cotizar} proporcional={proporcional}/>
                                        )
                                      })
                                    ) : null
                                  }
