...
export default function  CardProductoTiendaCell({producto, proporcional}) {
    ...
    return (
        <div className='shadow rounded' style={{width: 439 / proporcional, marginBottom: 40 / proporcional, marginLeft: 10 / proporcional, marginRight: 10 / proporcional}}
            ...
            <div className='position-relative' style={{width: 439 / proporcional}}>
                <div className='d-flex' style={{width: 439 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
                    <p style={{fontSize: 16 / proporcional, fontWeight: 700, lineHeight: `${18 / proporcional}px`, color: '#5f656d', paddingTop: 10 / proporcional,
                        paddingBottom: 10 / proporcional, marginTop: 15 / proporcional, marginBottom: 15 / proporcional, cursor: 'default', marginRight: 5 / proporcional}}>{producto.producto}:</p>
